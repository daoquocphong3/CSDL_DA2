...
AS BEGIN
    DECLARE @MASP CHAR(10), @MALOAI CHAR(10)
    ...
    DECLARE @LENGTH_ML INT = (SELECT COUNT(*) FROM LOAISP)
    ...
    BEGIN
        ...
        SET @MALOAI = 'LOAI' + CAST(CAST(RAND()*@LENGTH_ML+1 AS INT) AS CHAR(7))
        
        INSERT INTO SANPHAM VALUES(@MASP, @TENSP, @GIA, @TENTH, @XUATXUTH, @XUATXUSP,'/images/1.jpg', @MOTASP, @MALOAI)
    END
END
GO
...
AS BEGIN
    ...
    DECLARE @RAND INT,  @TRANGTHAI BIT
...
AS BEGIN
    INSERT INTO LOAISP VALUES ('LOAI1', N'Sữa tươi', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI2', N'Sữa Bột', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI3', N'Tả', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI4', N'Cháo dinh dưỡng', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI5', N'Đồ ăn dặm', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI6', N'Đồ dùng cho bé', '/images/1.jpg')
    INSERT INTO LOAISP VALUES ('LOAI7', N'Đồ chơi', '/images/1.jpg')
...
-- AS BEGIN
--     INSERT INTO LOAISP VALUES ('LOAI1', N'Sữa tươi', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI2', N'Tả', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI3', N'Sữa Bột', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI4', N'Cháo dinh dưỡng', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI5', N'Đồ ăn dặm', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI6', N'Đồ dùng cho bé', '/images/1.jpg')
--     INSERT INTO LOAISP VALUES ('LOAI7', N'Đồ chơi', '/images/1.jpg')
...
--     EXEC INSERTCH 10
--     EXEC INSERTNV 10
--     EXEC INSERTLSLUONG 10
--     EXEC INSERTDIEMDANH 10
--     EXEC INSERTKHO_NHAPKHO
--     EXEC INSERTDH 10
--     EXEC INSERTCT_DH
-- END
